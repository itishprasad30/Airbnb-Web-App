  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white p-5 shadow-md md:px-10">
      ...
      <div
        ...
        className="flex items-center space-x-4 justify-end text-gray-600"
      >
      ...
      {searchInput && (
        <div className="flex  flex-col col-span-3 mx-auto mt-5 ">
          ...
          <div className="flex  items-center justify-center space-x-5 h-10 ">
            ...
            <button
              onClick={search}
              className=" flex-grow bg-red-300 p-2 rounded-full hover:bg-red-400 items-center hover:shadow-md"
            >
              Search
            </button>
          </div>
